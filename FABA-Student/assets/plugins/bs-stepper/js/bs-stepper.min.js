...
!function(t, e) {
    ...
    , l = function(t, e, n, s) {
        n.forEach(function(e) {
            ...
            t.classList.contains(r.VERTICAL) && n.setAttribute("disabled", "disabled")
        }),
        e.classList.add(r.ACTIVE);
        var i = e.querySelector(s.selectors.trigger);
        i.setAttribute("aria-selected", "true"),
        t.classList.contains(r.VERTICAL) && i.removeAttribute("disabled")
    }
        ...
        return s._setLinkListeners = function() {
            ...
            this._steps.forEach(function(e) {
                ...
                i.addEventListener("click", function(t) {
                    t.preventDefault();
                    var e = n(t.target, t.options.selectors.steps)
                      , i = n(e, t.options.selectors.stepper)
                      , r = i[c]
                      , o = r._steps.indexOf(e);
                    a(i, o, t.options, function() {
                        r._currentIndex = o
                    })
                })
            })
